                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="padding-left:20px;padding-right:20px;font-family:Arial, Helvetica, sans-serif;font-size:12px;">
                                                        <p>Пользователь <a href="<?= Yii::app()->createAbsoluteUrl('user/profile', array('username'=>$mail->data['comment']->owner->username)); ?>" style="color:#135687;"><?= $mail->data['comment']->owner->profile->firstname ?> <?= $mail->data['comment']->owner->profile->lastname ?></a> добавил ответ к вашему комментарию на проекте "Твои Законы".</p>
