                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="padding-left:20px;padding-right:20px;">
                                                        <h2 style="font-family:Arial, Helvetica, sans-serif;font-size:24px;font-weight:lighter;">Здравствуйте, <?= $this->data['parent']->owner->firstname ?> <?= $this->data['parent']->owner->lastname ?></h2>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="padding-left:20px;padding-right:20px;font-family:Arial, Helvetica, sans-serif;font-size:12px;">
                                                        <p>Пользователь <a href="<?= Yii:app()->urlManager->createUrl('user/profile', array('username'=>$this->data['comment']->owner->username)); ?>" style="color:#135687;"><?= $this->data['comment']->owner->firstname ?> <?= $this->data['comment']->owner->lastname ?></a> добавил ответ к вашему комментарию на проекте "Твои Законы".</p>
